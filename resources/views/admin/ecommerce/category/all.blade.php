        ...
        <section class="page_content">
            ...
            <div class="panel mb-0">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="panel_title">
                                <span class="panel_icon"><i class="fas fa-border-all"></i></span><span>All
                                    Category</span>
                            </div>
                        </div>
                        <div class="col-md-6 text-right">
                            <div class="panel_title">
                                <a href="#" class="btn btn-success" data-toggle="modal" data-target="#myModal1"><i class="fas fa-plus"></i></span> <span>Add Category</span>
                                </a>
                            </div>
                        </div>
                    </div>
                ...
                <form action="{{url('admin/category/multiplesoftdelete')}}" method="Post">
                    @csrf
                    <button type="submit" style="margin: 5px;" class="btn btn-danger"><i class="fa fa-trash"></i> Delete
                        All</button>
                    <button type="button" style="margin: 5px;" class="btn btn-success"><i class="fas fa-recycle"></i> <a
                            href="{{route('admin.trash.category')}}" style="color: #fff;">Restore</a></button>
                            ...
                            <table id="dataTableExample1" class="table table-bordered table-striped table-hover mb-2">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>
                                            <label class="chech_container mb-4">
                                                <input type="checkbox" name="delid[]" class="checkbox"
                                                    value="{{$data->id}}">
                                                <span class="checkmark"></span>
                                            </label>
                                        </td>
                                        ...
                                        <td>
                                            <img src="{{asset('public/uploads/category/'.$data->cate_icon)}}"
                                                height="45px;">
                                        </td>
                                        <td>
                                            <img src="{{asset('public/uploads/category/'.$data->cate_image)}}"
                                                height="45px;">
                                        </td>
                                        <td>{{$data->cate_tag}}</td>
                                        ...
                                        <td>
                                            @if($data->cate_status==1)
                                            <a href="{{url('admin/category/deactive/'.$data->id)}}"
                                            ...
                                            @else
                                            <a href="{{url('admin/category/active/'.$data->id)}}"
                                                class="btn btn-default btn-sm text-white" data-toggle="tooltip"
                                                data-placement="right" title="active" data-original-title="Deactive"><i
                                            ...
                                            <a id="delete" href="{{url('admin/category/softdelete/'.$data->id)}}"
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="form-horizontal" action="{{route('admin.category.insert')}}" method="POST"
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8 row">
                            <div class="col-md-8">
                                ...
                                <img src="{{asset('public/adminpanel')}}/Capture.PNG" alt="asif" height="70px"
                                    width="150px">
                            </div>
                            <br>
                            <br>
                            ...
                            <div class="col-md-8">
                                ...
                                <img src="{{asset('public/adminpanel')}}/Capture2.PNG" alt="asif" height="70px"
                                    width="150px">
                            </div>
                            <br>
                            <br>
                            ...
                            <div class="col-md-8">
                                ...
                                <img src="{{asset('public/adminpanel')}}/Capture3.PNG" alt="asif" height="70px"
                                    width="150px">
                            </div>
                            <br>
                            <br>
                            ...
                            <div class="col-md-8">
                                ...
                                <img src="{{asset('public/adminpanel')}}/Capture4.PNG" alt="asif" height="70px"
                                    width="150px">
                            </div>
                            <div class="col-md-8">
                                <input type="radio" name="section_id" value="5" checked>
                                <img src="{{asset('public/adminpanel')}}/Capture5.PNG" alt="asif" height="70px"
                                    width="150px">
                            </div>
                            <br>
                            <br>
            ...
            <div class="modal-body">
                <form class="form-horizontal" action="{{route('admin.category.update')}}" method="POST"
                    ...
                    <div class="form-group row">
                        <label for="inputEmail3" class="col-sm-3 col-form-label text-right">Meta Tag:</label>
                        <div class="col-sm-8">
                            <input type="text" name="cate_tag_edit" id="cate_tag_edit"
                                class="form-control cate_tag_edit">
                        </div>
                    </div>
                    <div class="form-group text-right">
